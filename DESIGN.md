...
* The GitHub Action will run a script that will:
  ...
  * Branches are named `op-nightly-dev` for openpilot, `sp-release-mici` for sunnypilot C4, `sp-release-tizi`, `sp-staging`, `sp-dev` for sunnypilot C3X, and `sp-staging-tici` for sunnypilot C3.
