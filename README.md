...
3.  Force-push the patched codebases to the `op-nightly-dev`, `sp-release-mici`, `sp-release-tizi`, `sp-staging`, `sp-dev`, and `sp-staging-tici` branches in this repository.
    ...
    [![sp-staging-tici last commit](https://img.shields.io/github/last-commit/op201920226mtcorollaug/openpilot/sp-staging-tici?label=sp-staging-tici)](https://github.com/op201920226mtcorollaug/openpilot/tree/sp-staging-tici)
...
3. In the text field, enter the following:
   ...
   * comma.ai openpilot - _Patched version of comma's software, kept around more for upstreaming preview and testing than actual usage_
     * comma four: `op201920226mtcorollaug/op-nightly-dev`
